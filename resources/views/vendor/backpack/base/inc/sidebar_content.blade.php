...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
		<li class='nav-item'><a class='nav-link' href='{{ backpack_url('menuAsignado') }}'><i class='nav-icon fa fa-question'></i> Menus Asignados</a></li>
		<li class='nav-item'><a class='nav-link' href='{{ backpack_url('inscripcion') }}'><i class='nav-icon fa fa-question'></i> Inscripciones</a></li>
	</ul>
</li>
@endif
...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
		<li class='nav-item'><a class='nav-link' href="{{ backpack_url('unidadAcademica') }}"><i class='nav-icon fa fa-university'></i> Unidades Academicas</a></li>
		<li class='nav-item'><a class='nav-link' href="{{ backpack_url('comedor') }}"><i class='nav-icon fa fa-building'></i> Comedores</a></li>
		<li class='nav-item'><a class='nav-link' href='{{ backpack_url('bandaHoraria') }}'><i class='nav-icon fa fa-question'></i> Bandas Horarias</a></li>
	</ul>
</li>
...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
		...
		<li class='nav-item'><a class='nav-link' href='{{ backpack_url('plato') }}'><i class='nav-icon fa fa-question'></i> Platos</a></li>
		<li class='nav-item'><a class='nav-link' href='{{ backpack_url('insumo') }}'><i class='nav-icon fa fa-question'></i> Insumos</a></li>
